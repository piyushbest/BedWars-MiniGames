...
class Arena {
    ...
    public function loadGame() {
        ...
        $this->getPlugin()->getScheduler()->scheduleRepeatingTask($this->scheduler = new ArenaScheduler($this), 20);
    }
    ...
    public function startGame() {
        ...
        $this->getPlugin()->getScheduler()->scheduleRepeatingTask($this->genScheduler = new GeneratorScheduler($this), 1);
